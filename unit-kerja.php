...
<body>
    ...
    <main class=" mx-32 my-16">
        <h1 class="mx-auto block text-center text-4xl uppercase font-bold my-6 text-[#215968]">Unit Kerja</h1>
        <section class="w-full  bg-red- grid grid-cols-2 text-justify">
            ...
            <div class=" overflow-hidden m-6">
                <h2 class="block text-2xl font-semibold tracking-wide mb-4">Unit Kerja NUDS</h2>
