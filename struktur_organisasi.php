...
<body>
    ...
    <main class=" mx-32 my-16">
        <h1 class="mx-auto block text-center text-4xl uppercase font-bold my-6 text-[#215968]">struktur organisasi</h1>
        <section class="w-full  text-justify">
            <div class="bg-blue-100 overflow-hidden rounded-lg m-6">
                <img class="w-full h-full" src="img/struktur.png" alt="" srcset="">
            </div>
            <div class=" overflow-hidden m-6">
                <h2 class="block text-2xl font-semibold tracking-wide mb-4">Struktur Organisasi</h2>
